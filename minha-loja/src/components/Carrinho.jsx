...
function Carrinho({
  ...
  return (
    <section className="bg-ligth p-4 rounded shadow-sm">
      {carrinho.length === 0 ? (
        <div className="alert alert-secondary fs-4">Carrinho vazio</div>
      ) : (
        <>
          <div className="bg-secondary-subtle p-3 rounded mb-4">
            <p className="mb-1 fw-semibold fs-4">Itens: {calcularTotalItens()}</p>
            <p className="mb-0 fw-semibold fs-4">Total: R$ {calcularTotal().toFixed(2)}</p>
              ...
              >
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mb-0 fw-semibold">R$ {item.preco.toFixed(2)}</p>
                  </div>
                </div>
